<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"> Panel Pilihan Pertanyaan Essai</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb">               
                ...
                <li class="active">Pilihan Pertanyaan Essai</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="form" data-toggle="" action="<?php echo site_url('kuisioner/post_panel_essai/' . $get_kuisioner[0]->id_kuisioner . '/' . $get_panel[0]->id_panel); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="white-box">       
                                ...
                                <div class="col-md-12 col-xs-12 col-lg-12"> 
                                    <img src="<?php echo base_url('/uploads/data/pil_essai.gif') ?>" alt="user" class="m-t-5 m-b-20 col-md-12 col-xs-12 col-lg-12">                    
                                </div>
                ...
                <div class="col-md-9 col-lg-9 col-sm-7">
                    <div class="row">
                        <div class="white-box col-md-12">
                            <h3 class="box-title m-b-0">Formulir Pertanyaan Pilihan Essai</h3>
                            <p class="text-muted m-b-20"> Silahkan Isi Formulir Pertanyaan Pilihan Essai Disini..</p>
                            <hr>
                            <div class="col-md-12 ">  
                                <?php
                                if (!empty($get_essai)) {
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" > 
                                                <label for="namamhs" class="control-label">Jumlah Karakter *</label>
                                                <div class="help-block with-errors"></div>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="ti-link"></i></div>                                              
                                                    <input type="number" min="1" name="jumlah_karakter" value="<?php echo $get_essai[0]->jumlah_karakter; ?>" class="form-control" id="namamhs" placeholder="Inputkan Jumlah Karakter disini" required>
                                                </div>                           
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" > 
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="ti-link"></i></div>                                              
                                                    <input type="number" min="1" name="jumlah_karakter" class="form-control" id="namamhs" placeholder="Inputkan Jumlah Karakter disini" required>
                                                </div>                           
                                                <small class="form-text"><b class="text-danger">*WAJIB </b>diisi</small>  
                                            </div>
                                        </div>     
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="">
                                            <textarea class="form-control" disabled="" rows=9 name="deskripsi_kuisioner">Karena UIN Kampus Islami Yang Berwawasan IPTEK dan IMTEK</textarea>
                                            <small class="form-text"><b class="text-danger">*ADMIN TIDAK MENGISI KOLOM INI</b>, (Contoh Jawaban Mahasiswa)</small>  
                                        </div>
                                    </div> 
                                </div>   
                                <div class="col-md-12">
