    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="white-box col-md-12">
                <form class="form" data-toggle="validator" action="<?php echo site_url('master/mahasiswa/post_data_mahasiswa'); ?>" enctype="multipart/form-data" method="post">
                    <h3 class="box-title m-b-0">Formulir Tambah Data Mahasiswa</h3>
                    <p class="text-muted m-b-20"> Silahkan Isi Kriteria Mahasiswa Disini..</p>
                    <hr>
                    <div class="col-md-12 ">                                      
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group" > 
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nama_mhs" class="form-control" id="namamhs" placeholder="Inputkan Nama Mahasiwa" required>
                                    </div>                           
                            ...
                            <div class="col-md-3">
                                <div class="form-group" > 
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="nim_mhs" class="form-control" id="nimmhs" placeholder="Inputkan NIM Mahasiswa" required>
                                    </div>                           
                            ...
                            <div class="col-md-3">
                                <div class="form-group" > 
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="password_mhs" class="form-control" id="passmhs" placeholder="Inputkan Password Mahasiswa" required>
                                    </div>                           
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email_mhs" class="form-control" id="emailmhs" placeholder="Inputkan Email" >
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="nomor_hp_mhs" class="form-control" id="nohpmhs" placeholder="inputkan Nomor Handphone">
                                    </div>
                                    <small class="form-text"><b class="text-danger">*TIDAK </b>wajib diisi</small> 
                                </div>
                            </div>  
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="nomor_ijazah_mhs" class="form-control" id="noijazahmhs" placeholder="Inputkan Nomor Ijazah">
                                    </div>
                                    <small class="form-text"><b class="text-danger">*TIDAK </b> wajib diisi</small> 
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="tahun_masuk_mhs" class="form-control mydatepicker" id="thnmasukmhs" placeholder="Tahun Masuk" required>
                                    </div>
                                    <small class="form-text"><b class="text-danger">*TIDAK </b> wajib diisi</small> 
                                </div>
                            </div>  
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="ti-calendar"></i></div>
                                        <input type="text"  name="tahun_lulus_mhs" class="form-control mydatepicker" id="thnlulusmhs" placeholder="Tahun Lulus" required>
                                    </div>
                                    <small class="form-text"><b class="text-danger">*TIDAK </b> wajib diisi</small> 
                                </div>
                            </div>  
...
<?php if ($user['role_akun'] == 2) { ?>
            $("#fakultasmhs").change(function () {
                id_fak = $(this).val();
                var url = "<?php echo site_url('master/mahasiswa/add_ajax_prodi_role'); ?>/" + id_fak + '/' +<?php echo $user['id_prodi'] ?>;
                $('#prodimhs').load(url);
                return false;
            });
