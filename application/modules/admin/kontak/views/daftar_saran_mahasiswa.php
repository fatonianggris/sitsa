<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Halaman Saran Mahasiswa</h4>
        </div>
    ...
    <!--            <a href="" data-toggle="modal" data-target=".modal-tambahfaq" class="btn btn-info pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light"><i class="fa fa-plus m-r-5"></i>Tambah FAQ </a>-->
            <ol class="breadcrumb">               
                ...
                <li class="active">Daftar Saran Mahasiswa</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">Daftar Saran Mahasiswa</h3>
                <p class="text-muted m-b-30">Berikut daftar saran masuk yang berasal dari mahasiswa</p>
                <div class="table-responsive">
                    <table id="table_saran" class="display nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>                                
                        ...
                        <tbody>
                            <?php
                            if (!empty($saran_mahasiwa)) {
                                foreach ($saran_mahasiwa as $key => $value) {
                                    ?> 
                                    <tr>
                                        <td><?php echo strtoupper($value->nama_mhs); ?></td>
                                        <td><?php echo strtoupper($value->nama_fakultas); ?></td>
                                        <td><?php echo strtoupper($value->nama_prodi); ?></td>                                                                         
                                        <?php
                                        $words = explode(" ", strip_tags($value->isi_saran));
                                        ...
                                        <td>
                                            ...
                                            <a onclick="act_delete_laporan(<?php echo $value->id_saran; ?>, '<?php echo strtoupper($value->nama_mhs); ?>')" ><button class="btn btn-outline btn-danger btn-sm waves-effect waves-light"><i class="fa fa-trash"></i></button></a>
                                        </td>                                
                                    </tr>                                   
                                    <?php
                                }  //ngatur nomor urut
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content modal-lg">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myLargeModalLabel">Detail Saran Mahasiswa</h4>
                        <small>Detail Saran Mahasiswa terkait Kuisioner </small>
                    </div>
                    <div class="modal-body">          
                        <div class="panel-group" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-info">
                                <div class="panel-heading" role="tab" id="headingTwo">
                                    <h4 class="panel-title"> <a class="collapsed font-bold" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" ><?php echo $value->nama_mhs; ?> - <?php echo $value->nim_mhs; ?> </a> </h4>
                                </div>
                                <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                    <div class="panel-body"> 
                                        <?php echo $value->isi_saran; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#table_saran tfoot th').each(function () {
...
<script>
    function act_delete_laporan(object, name) {
        swal({
            ...
            text: "Apakah anda yakin ingin menghapus Saran atas Nama (" + name + ")?",
            type: "warning",
            ...
            if (isConfirm) {
                $.ajax({
                    type: "post",
                    url: "<?php echo site_url("kontak/delete_saran_mahasiswa") ?>",
                    data: {id: object},
                    dataType: 'html',
                    success: function (result) {
                        swal("Terhapus!", "Saran atas nama (" + name + ") telah terhapus.", "success");
                        setTimeout(function () {
                            location.reload();
                        }, 1000);
                    },
                ...
                swal("Dibatalkan", "Saran atas nama (" + name + ") batal dihapus.", "error");
            }
        });
    }
</script>
