<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"> Panel Pilihan Jawaban Singkat</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb">               
                ...
                <li class="active">Pilihan Jawaban Singkat</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="form" data-toggle="" action="<?php echo site_url('kuisioner/post_panel_jawaban_singkat/' . $get_kuisioner[0]->id_kuisioner . '/' . $get_panel[0]->id_panel); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="white-box">       
                                ...
                                <div class="col-md-12 col-xs-12 col-lg-12"> 
                                    <img src="<?php echo base_url('/uploads/data/pil_jwb_singkat.gif') ?>" alt="user" class="m-t-5 m-b-20 col-md-12 col-xs-12 col-lg-12">                    
                                </div>
                ...
                <div class="col-md-9 col-lg-9 col-sm-7">
                    <div class="row">
                        <div class="white-box col-md-12">
                            <h3 class="box-title m-b-0">Formulir Pertanyaan Pilihan Jawaban Singkat</h3>
                            <p class="text-muted m-b-20"> Silahkan Isi Formulir Pertanyaan Pilihan Jawaban Singkat Disini..</p>
                            <hr>
                            <div class="col-md-12 ">  
                                <?php
                                if (!empty($get_jawaban_singkat)) {
                                    ?>
                                    <div class="col-md-12">
                                        <div class="col-md-10">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group" > 
                                                <label for="namamhs" class="control-label">Tipe Pertanyaan *</label>
                                                <div class="help-block with-errors"></div>
                                                <select class="form-control required " name="tipe_pertanyaan" id="tujuan" required>
                                                    <option value="">PILIH TIPE</option>   
                                                    <?php if ($get_jawaban_singkat[0]->tipe_pertanyaan == "email") { ?>
                                                        <option selected value="email">EMAIL</option>  
                                                    <?php } else if ($get_jawaban_singkat[0]->tipe_pertanyaan == "number") {
                                                        ?>
                                                        <option selected value="number">ANGKA</option>
                                                    <?php } else { ?>
                                                        <option selected value="text">TEKS</option> 
                                                    <?php }
                                                    ?>
