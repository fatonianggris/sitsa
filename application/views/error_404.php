...
<head>
    ...
    <!-- color CSS -->
    <link href="<?php echo base_url(); ?>main_assets/admin_asset/assets/css/colors/default.css" id="theme" rel="stylesheet">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="javascript:history.back()" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
