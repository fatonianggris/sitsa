...
<div id="wizard_container_700">
    ...
    <form id="wrapped" method="POST" action="<?php echo site_url('trace/post_jawaban_kisi_tunggal/' . $get_panel[0]->id_panel); ?>" enctype="multipart/form-data">
                ...
                <table class="table table-borderless" id="table1">
                    ...
                    <tbody>
                        <?php foreach ($get_baris as $keys => $value_b) { ?>
                            <tr>
                                <td>
                                    <label class="container_radio container_radio_kisi">
                                ...
                                <?php foreach ($get_kolom as $keyz => $value_k) { ?>
                                    <td class="text-center">
                                        <label class="container_radio container_radio_kisi ">
                                            <input type="radio" name="opsi_kolom<?php echo $keys; ?>" value="<?php echo $value_k->opsi_kolom; ?>" class="<?php echo $get_panel[0]->status_required_panel; ?>">
