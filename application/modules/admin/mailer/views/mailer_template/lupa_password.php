                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="mpx-10">
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                                                                    <a href="<?php echo base_url() ?>" target="_blank"><img src="<?php echo base_url() . $general[0]->logo_website; ?>" width="152" border="0" alt="" /></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- Logo -->
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td class="pb-50" style="padding-bottom: 50px;">
                                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                    <tr>
                                                                                                        <td class="fluid-img img-center pb-50" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 20px;">
                                                                                                            <img src="<?php echo base_url() . 'uploads/data/notifikasi/img_intro_4.png'; ?>" width="30%" border="0" alt="" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
                                                                                                            Click on the button below to reset your password, you have 24 hours to pick your password. After that, you'll have to ask for a new one.
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td class="pb-30" style="padding-bottom: 10px;">
                                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                <tr>
                                                                                                                    <td class="title-22 a-center py-20 px-50 mpx-15" style="border-radius: 10px; border: 1px dashed #b4b4d4; font-size:22px; line-height:26px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-top: 20px; padding-bottom: 20px; padding-left: 50px; padding-right: 50px;" bgcolor="#f4ecfa">
                                                                                                                        <strong>USE CODE : <span class="c-purple" style="color:#9128df;">PURPLE123</span></strong>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            </table>
                                                                                                        </td>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="p-50 mpx-15" bgcolor="#949196" style="border-radius: 0 0 10px 10px; padding: 20px;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                        ...
                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                    <a href="<?php echo $kontak[0]->akun_facebook; ?>" target="_blank"><img src="<?php echo base_url() . 'uploads/data/notifikasi/ico_facebook.png'; ?>" width="34" height="34" border="0" alt="" /></a>
                                                                                </td>
                                                                                <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                                <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                    <a href="<?php echo $kontak[0]->akun_instagram; ?>" target="_blank"><img src="<?php echo base_url() . 'uploads/data/notifikasi/ico_instagram.png'; ?>" width="34" height="34" border="0" alt="" /></a>
                                                                                </td>
                                                                                <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                                <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                    <a href="<?php echo $kontak[0]->akun_twitter; ?>" target="_blank"><img src="<?php echo base_url() . 'uploads/data/notifikasi/ico_twitter.png'; ?>" width="34" height="34" border="0" alt="" /></a>
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                        <?php echo $kontak[0]->alamat; ?>
                                                                        <br />
                                                                        <a href="tel:<?php echo $kontak[0]->no_handphone; ?>" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;"><?php echo $kontak[0]->no_handphone; ?></span></a>
                                                                        <br />
                                                                        <a href="mailto:<?php echo $kontak[0]->email; ?>" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;"><?php echo $kontak[0]->email; ?></span></a> - <a href="<?php echo base_url(); ?>" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;"><?php echo base_url(); ?></span></a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center">
                                                                        ...
                                                                        <table border="0" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                    <a href="#" target="_blank"><img src="<?php echo base_url() . 'uploads/data/notifikasi/btn_gplay.png'; ?>" width="117" height="40" border="0" alt="" /></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        <!-- END Download App -->
