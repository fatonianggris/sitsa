<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"> Panel Pertanyaan Dropdown</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb">               
                ...
                <li class="active">Pertanyaan Dropdown</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="form" data-toggle="" action="<?php echo site_url('kuisioner/post_panel_pilihan_dropdown/' . $get_kuisioner[0]->id_kuisioner . '/' . $get_panel[0]->id_panel); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="white-box">       
                                ...
                                <div class="col-md-12 col-xs-12 col-lg-12"> 
                                    <img src="<?php echo base_url('/uploads/data/pil_dropdown.gif') ?>" alt="user" class="m-t-5 m-b-20 col-md-12 col-xs-12 col-lg-12">                    
                                </div>
                ...
                <div class="col-md-9 col-lg-9 col-sm-7">
                    <div class="row">
                        <div class="white-box col-md-12">
                            <h3 class="box-title m-b-0">Formulir Pertanyaan Dropdown</h3>
                            <p class="text-muted m-b-20"> Silahkan Isi Formulir Pertanyaan Dropdown Disini..</p>
                            <hr>
                            <div class="col-md-12 ">  
                                <div class="col-md-12 ">  
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">                                            
                                                <select class="form-control required" disabled name="panel_tujuan[]" id="opsi_tujuan_lanjutan2" required>
                                                    <option value="">Pilih Panel</option>                                                    
                                                    <?php if ($get_tujuan_lainnya_dropdown[0]->panel_tujuan == '0') { ?>
                                                        <option selected value="0">*NANTI SAJA</option>
                                                    <?php } else { ?>
                                                        <option value="0">*NANTI SAJA</option>
                                                    <?php } ?>
                                                    ...
                                                    if (!empty($get_all_panel_excpt)) {
                                                        foreach ($get_all_panel_excpt as $keys => $all_panel) {
                                                            if ($all_panel->id_panel == $get_tujuan_lainnya_dropdown[0]->panel_tujuan) {
                                                                ?> 
                                                                <option selected value="<?php echo $all_panel->id_panel; ?>"><?php echo strtoupper($all_panel->nama_panel); ?></option>    
                                                            <?php } else { ?>
                                                                <option value="<?php echo $all_panel->id_panel; ?>"><?php echo strtoupper($all_panel->nama_panel); ?></option>    
