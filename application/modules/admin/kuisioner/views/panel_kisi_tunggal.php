<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"> Panel Pertanyaan Kisi Tunggal</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <ol class="breadcrumb">               
                ...
                <li class="active">Pertanyaan Kisi Tunggal</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form class="form" data-toggle="" action="<?php echo site_url('kuisioner/post_panel_kisi_tunggal/' . $get_kuisioner[0]->id_kuisioner . '/' . $get_panel[0]->id_panel); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="col-md-12">
                            <div class="white-box">       
                                ...
                                <div class="col-md-12 col-xs-12 col-lg-12"> 
                                    <img src="<?php echo base_url('/uploads/data/kisi_tunggal.gif') ?>" alt="user" class="m-t-5 m-b-20 col-md-12 col-xs-12 col-lg-12">                    
                                </div>
                ...
                <div class="col-md-9 col-lg-9 col-sm-7">
                    <div class="row">
                        <div class="white-box col-md-12">
                            <h3 class="box-title m-b-0">Formulir Pertanyaan Kisi Tunggal</h3>
                            <p class="text-muted m-b-20"> Silahkan Isi Formulir Pertanyaan Kisi Tunggal Disini..</p>
                            <hr>
                            <div class="col-md-12 ">  
                                <div class="col-md-12">
                                    <div class="form-group" > 
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="pertanyaan" class="form-control" id="namamhs" value="<?php echo $get_panel[0]->pertanyaan; ?>" placeholder="Inputkan Pertanyaan anda disini" required>
                                        </div>                           
                                ...
                                if (!empty($get_baris) || !empty($get_kolom)) {
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-content form-group">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php foreach ($get_kolom as $key => $value_k) { ?>
                                                            <th> 
                                                                <input type="text" name="kolom[]" onkeyup="checkValueRealTimeKolom()" value="<?php echo $value_k->opsi_kolom; ?>" class="form-control row-limit pull-left" placeholder="Isi Kolom" required/>                                                                  
                                                    ...
                                                    <?php foreach ($get_baris as $keys => $value_b) { ?>
                                                        <tr>
                                                            ...
                                                            <?php foreach ($get_kolom as $keyz => $value_k) { ?>
                                                                <td>
                                                                    <input type="radio" name="<?php echo $keys; ?>">
                                                                </td>
                                                            <?php } ?>
                                                        </tr>
                                                    <?php } ?>
                                            ...
                                            <a class="btn btn-warning add-row m-b-10"><i class="fa fa-plus m-r-5"></i>BARIS</a>
                                        </div>
                                    </div>
                                    <?php
                                } else {
                                            ...
                                            <table class="table table-responsive text-center" id="table1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>BARIS/KOLOM</th>
                                                        <th > 
                                                            <input type="text" name="kolom[]" onkeyup="checkValueRealTimeKolom()" class="form-control row-limit pull-left" placeholder="Isi Kolom" required/>                                                                  
                                                            <a href="javascript:void(0)" class="remove remove-col pull-left m-l-5" title="" data-toggle="" data-original-title="Hapus"><i class="ti-trash text-dark line-kisi"></i></a>
                                                        </th>
                                                    </tr>
                                                </thead>
...
<script>
// add row
    var totalColumnCount = document.getElementById('table1').rows[0].cells.length;
...
// add column
    $(document).on('click', '.add-col', function () {
        $('table tr').each(function () {
            $(this).append($(this).find('th:last').clone().find("input:text").val("").end());
